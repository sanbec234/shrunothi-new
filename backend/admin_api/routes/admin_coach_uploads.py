...
bp = Blueprint("admin_coach_uploads", __name__)
...
@bp.route("/admin/uploads/coach-presign", methods=["POST", "OPTIONS"])
@require_admin
def presign_coach_upload():
    """Generate presigned URL for coach photo uploads."""
