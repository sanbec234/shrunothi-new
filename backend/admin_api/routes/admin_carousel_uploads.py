...
bp = Blueprint("admin_carousel_uploads", __name__)
...
@bp.route("/admin/uploads/carousel-presign", methods=["POST", "OPTIONS"])
@require_admin
def presign_carousel_upload():
    """Generate presigned URL for carousel banner uploads."""
