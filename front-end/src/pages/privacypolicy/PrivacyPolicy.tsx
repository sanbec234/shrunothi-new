  ...
  return (
    <div className="privacy-root">
      <div className="privacy-policy">
        ...
        <p>
          The website is not intended for users under 16 years of age.
        </p>

        <h2>10. Changes</h2>
        <p>
          Updates to this policy will be posted with a revised date.
        </p>
        ...
        <p>Effective Date: 27/01/2026</p>

        <h2>1. Acceptance of Terms</h2>
        <p>
          By using Shrunothi, you agree to these Terms.
        </p>

        <h2>2. Description of Services</h2>
        <p>
          Shrunothi provides curated coaching guidance and learning resources.
        </p>
        ...
        <p>
          Users must use the website lawfully and responsibly.
        </p>

        <h2>5. Intellectual Property</h2>
        <p>
          All content belongs to Shrunothi unless stated otherwise.
        </p>

        <h2>6. Limitation of Liability</h2>
        <p>
          Shrunothi is not liable for indirect or consequential damages.
        </p>
